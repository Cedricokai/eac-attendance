...
function Sidebar() {
  ...
  return (
    <aside className="h-full w-64 bg-gray-800 text-gray-100 p-4 flex flex-col">
      {/* Logo/Header */}
      ...
      <nav className="flex-1 space-y-1">
        ...
        <Link 
          to="/dashboard"
          className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive("/dashboard") ? "bg-blue-600 text-white" : "hover:bg-gray-700"}`}
        >
          <Home size={18} />
          Dashboard
        </Link>
        ...
        <div>
          ...
          {openDropdowns.attendance && (
            <div className="ml-8 mt-1 space-y-1">
              ...
              <Link 
                to="/overview"
                className={`flex items-center gap-3 px-4 py-2 rounded-lg text-sm ${isActive("/attendance/overview") ? "bg-blue-600 text-white" : "hover:bg-gray-700"}`}
              >
                <BarChart size={16} />
                Overview
              </Link>
              <Link 
                to="/timesheets"
                className={`flex items-center gap-3 px-4 py-2 rounded-lg text-sm ${isActive("/attendance/timesheets") ? "bg-blue-600 text-white" : "hover:bg-gray-700"}`}
              >
                <Clock size={16} />
                Timesheets
              </Link>
