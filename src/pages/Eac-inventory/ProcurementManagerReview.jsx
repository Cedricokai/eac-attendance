...
const ProcurementManagerReview = () => {
  ...
  const fetchRequests = async () => {
    setLoading(true);
    try {
      const response = await productRequestAPI.getProcurementPendingRequests();
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      await productRequestAPI.approveBYProcurement(currentRequest.id, approvalData);
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      await productRequestAPI.rejectByProcurement(currentRequest.id, rejectionData);
